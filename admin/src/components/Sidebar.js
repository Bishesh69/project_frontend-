...
const Sidebar = () => {
  ...
  const menuItems = [
    ...
    { path: '/users', name: 'Users', icon: 'M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197m13.5-9a2.5 2.5 0 11-5 0 2.5 2.5 0 015 0z' },
    { path: '/quizzes', name: 'Quizzes', icon: 'M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z' },
  ...
  return (
    <div className="sidebar">
      ...
      <div className="mt-auto pt-8">
        <button className="sidebar-item w-full text-left flex items-center text-red-300 hover:text-red-100 hover:bg-red-600">
          <svg className="h-5 w-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
